...
const s_formId = "1FAIpQLSd1scmOmq3qU9LyMKK1J0SR4QGnlqK7qDCQIkA38i0OqZBHQA";
const s_nameId = "1383232667";
const s_websiteId = "128294500";
const s_textId = "1714654083";
const s_pageId = "497808512";
const s_replyId = "817168380";
const s_sheetId = "1OyufEOatTGrxGQ9OrMhQq0nXzPeoSAfYW61iu63_-7E";
...
const s_dstStart = ["March", "Sunday", 30, 2]; // Example shown is the second Sunday of March at 2:00 am
const s_dstEnd = ["October", "Sunday", 26, 3]; // Example shown is the first Sunday of November at 2:00 am
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input placeholder="Cool person" class="c-input c-nameInput" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_websiteWrapper" class="c-inputWrapper">
        ...
        <input placeholder="https://coolsite dot whatever" class="c-input c-websiteInput" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" pattern="https://.*">
    </div>

    <div id="c_textWrapper" class="c-inputWrapper">
        <label class="c-label c-textLabel" for="entry.${s_textId}">${s_textFieldLabel}</label>
        <textarea placeholder="I'm a cool person" class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" required></textarea>
    </div>

    <input id="c_submitButton" class="button-class" name="c_submitButton" type="submit" value="${s_submitButtonLabel}" disabled>
`;
