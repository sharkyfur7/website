import { setValue, getValue } from "./localstorage.js";

const valueMinutes = 5;
let data = {
  view: 0,
  follow: 0,
  update: 0,
...
async function checkCookies() {
  if (!getValue("nw-view")) {
    ...
    setValue("nw-follow", response.followers, valueMinutes);
    setValue("nw-update", response.updates, valueMinutes);
  }
}
...
data.view = getValue("nw-view");
data.follow = getValue("nw-follow");
data.update = getValue("nw-update");
